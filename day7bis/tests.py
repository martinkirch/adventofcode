...
class TodayTest(TestCase):
    def test_hand(self):
        ...
        self.assertListEqual(h.hand, [3, 2, 10, 3, 12])
    ...
    def test_ordering(self):
        self.assertLess(Hand("32T3K 765"), Hand("KK677 28"))
        # self.assertLess(Hand("KK677 28"), Hand("T55J5 684"))
        # self.assertLess(Hand("T55J5 684"), Hand("KTJJT 220"))
        # self.assertLess(Hand("KTJJT 220"), Hand("QQQJA 483"))
